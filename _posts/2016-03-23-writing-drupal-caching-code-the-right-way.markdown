...
Below is an example of how to do caching in Drupal with a static variable.
...
function example_module_get_cached_data() {
  // Initialise the a static variable.
  // Static variable is added speed boost if this call is made more than once during the execution. 
  static $example_data;
